...
class Config:
    ...
    def _load_config(self) -> None:
        ...
        parser.add_argument("-chat-id", type=int, help="User or group ID of the Telegram chat")
        ...
        parser.add_argument("--api-port", type=int, help="Port of the monitoring API")
        ...
        parser.add_argument("--apt-threshold", type=int, help="APT packages threshold")
        parser.add_argument("--apt-security-threshold", type=int, help="APT security packages threshold")
        parser.add_argument("--disk-threshold", type=int, help="Free disk space threshold")
        parser.add_argument("--load-1-threshold", type=int, help="1 min load threshold")
        parser.add_argument("--load-5-threshold", type=int, help="5 min load threshold")
        parser.add_argument("--load-15-threshold", type=int, help="15 min load threshold")
        parser.add_argument("--ram-threshold", type=int, help="Free RAM threshold")
        parser.add_argument("--swap-threshold", type=int, help="Free swap threshold")
        parser.add_argument("--users-threshold", type=int, help="Logged in users threshold")
        parser.add_argument("--alert-interval", type=int, help="Interval for alerts te be send in minutes")
        ...
        self.apt_security_threshold = get_env_var(args.apt_security_threshold, "APT_SECURITY_THRESHOLD", "1")
